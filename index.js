$(document).ready(function(){
    ...
    $(".bf-goal").bind("click touchstart", function(){
    ...
    $(".mg-goal").bind("click touchstart", function(){
        $(this).removeClass("inactive");
    ...
    $(".ma-goal").bind("click touchstart", function(){
        $(this).removeClass("inactive");
        $(".bf-goal").addClass("inactive");
        $(".mg-goal").addClass("inactive");
        $(".bf").slideDown(500);
    ...
    $(".yes").bind("click touchstart", function(){
        $(this).removeClass("inactive");
    ...
    $(".no").bind("click touchstart", function(){
        $(this).removeClass("inactive");
    ...
    $(".calculate").bind("click touchstart", function(){
